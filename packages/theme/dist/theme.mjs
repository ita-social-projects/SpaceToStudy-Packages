...
function createUnaryUnit(theme2, themeKey, defaultValue, propName) {
  var _a;
  const themeSpacing = (_a = getPath(theme2, themeKey, true)) != null ? _a : defaultValue;
...
function unstable_createStyleFunctionSx() {
  ...
  function styleFunctionSx2(props) {
    ...
    const config = (_a = theme2.unstable_sxConfig) != null ? _a : defaultSxConfig_default;
...
function createThemeWithVars(options = {}, ...args) {
  ...
  Object.keys(theme2.colorSchemes).forEach((key) => {
    const palette3 = theme2.colorSchemes[key].palette;
...
function createTheme2(options = {}, ...args) {
  const {
    ...
    defaultColorScheme: initialDefaultColorScheme = palette3 == null ? void 0 : palette3.mode,
    ...rest
  } = options;
...
// lib/Pallete/app.pallete.ts
var palette2 = {
  primary: blueGrey_default,
...
// lib/Custom-shadows/custom-shadows.ts
var mainShadow = "0px 5px 6px -3px rgba(144, 164, 174, 0.2), 0px 9px 12px 1px rgba(144, 164, 174, 0.14), 0px 3px 16px 2px rgba(144, 164, 174, 0.12)";
var commonShadow = "0px 3px 16px 2px rgba(144, 164, 174, 0.12)";
var commonHoverShadow = "0px 3px 16px 2px rgba(144, 164, 174, 0.56)";
var smallHoverShadow = "0 3px 1px rgba(144, 164, 174, 0.56)";

// lib/MenuList/app.menu-list.ts
var menuList = {
  styleOverrides: {
    root: {
      "& .MuiPaper-root": {
...
var app_table_default = table;

// lib/Custom-scrollbar/custom-scrollbar.ts
var scrollbar = {
...
// lib/TextField/app.textfield.ts
var textField = {
  styleOverrides: {
    root: {
      ...textfieldScrollbar,
...
var app_tooltip_default = tooltip;

// lib/Typography/app.typography.ts
var appTypography = {
...
var app_typography_default = appTypography;

// lib/Custom-animations/custom-animations.ts
var fade = keyframes`
  from {
    opacity: 0.3;
  }
...
var theme = createTheme2({
  ...
  components: {
    ...
    MuiSelect: select,
    MuiTooltip: app_tooltip_default,
    MuiMenuItem: menuItem,
    MuiMenu: menuList,
    MuiTableRow: app_table_default
  }
});
export {
